...
<%-- 2. 页面内容 --%>
<table id="sysMenuPermissionDataGrid" title="菜单权限列表" style="" toolbar="#sysMenuPermissionToolbar" rownumbers="true"  style="width: 100%" fitColumns="true">
	<thead>
		<tr>
...
<div id="sysMenuPermissionToolbar">
	<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="sysMenuPermission.toAdd(true)">添加菜单权限</a>
	<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true" onclick="sysMenuPermission.toEdit()">修改菜单权限</a>
	<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-arrow_up',plain:true" onclick="sysMenuPermission.toMove(1)">菜单上移</a>
	<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-arrow_down',plain:true" onclick="sysMenuPermission.toMove(-1)">菜单下移</a>
	<a class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="sysMenuPermission.toDelete()">删除菜单权限</a>
</div>
...
<div id="sysMenuPermissionContextMenu" class="easyui-menu"
	...
	<div onclick="sysMenuPermission.toMove(-1)" data-options="iconCls:'icon-remove'">下移</div>
	<div class="menu-sep"></div>
	<div onclick="sysMenuPermission.toAdd(true)" data-options="iconCls:'icon-add'">添加</div>
	<div onclick="sysMenuPermission.toEdit()" data-options="iconCls:'icon-edit'">修改</div>
	<div onclick="sysMenuPermission.toDelete()" data-options="iconCls:'icon-remove'">删除</div>
	<div class="menu-sep"></div>
