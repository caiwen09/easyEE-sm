...
<%-- 2. 页面内容 --%>
<table id="sysLogDataGrid" title="用户列表" style="width: 100%" toolbar="#sysLogToolbar" idField="logId" rownumbers="true" fitColumns="true" nowrap="false" >
	<thead>
		<tr>
			<th field="action" width="100" sortable="true">操作动作</th>
	...
	<div>
		...
		<span>操作日期:</span>
		 ...
		 <input name="endTime" id="sysLogEndTime" class="easyui-datetimebox" style="width:200px" data-options="
            ...
            ">
		<a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="sysLog.doSearch()">
		<spring:message code="label.search"></spring:message></a>
	</div>
</div>