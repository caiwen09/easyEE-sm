	    		...
	    		<tr>
	    			...
	    			<td>
						 <select id="sysMenuPermissionEditIcon" data-options="formatter: sysMenuPermission.formatEditIconItem,                
							url: 'static/easyee/json/icon.json',
							method: 'get',
							valueField: 'name',
							textField: 'name',
...
<div id="sysMenuPermissionEdit-dlg-buttons">
	<a class="easyui-linkbutton" id="sysMenuPermissionEditSaveBtn" iconCls="icon-ok" onclick="sysMenuPermission.edit()">修改</a> <a class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:uiEx.closeDialog('#sysMenuPermissionEditDialog')">取消</a>
</div>