...
<div id="sysRoleEdit-dlg-buttons">
	<a class="easyui-linkbutton" id="sysRoleEditSaveBtn" iconCls="icon-ok" onclick="sysRole.edit()">修改</a> <a class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:uiEx.closeDialog('#sysRoleEditDialog')">取消</a>
</div>