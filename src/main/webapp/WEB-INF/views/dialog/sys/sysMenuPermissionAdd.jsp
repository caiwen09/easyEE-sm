...
<div id="sysMenuPermissionAdd-dlg-buttons">
	<a class="easyui-linkbutton" id="sysMenuPermissionAddSaveBtn" iconCls="icon-ok" onclick="sysMenuPermission.add()">添加</a>
	<a class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:uiEx.closeDialog('#sysMenuPermissionAddDialog')">取消</a>
</div>